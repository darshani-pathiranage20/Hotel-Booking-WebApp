...
const HotelCard = ({ room, index }) => {
  return (
    <Link 
      ...
      key={room._id} className="relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px rgba(0,0,0,0,0.05)]"
    >
      <img src={room.images[0]} alt="" />

    {/* best seller tag display only for selected cards */}
      ...
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center gap-1 text-sm">
          <img src={assets.lacationIcon} alt="location-icin" />
